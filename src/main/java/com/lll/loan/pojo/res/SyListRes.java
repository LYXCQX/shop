...
public class SyListRes {
	...
	private BigDecimal loanRate;// 利息
	...
	public String toString() {
		return "SyListRes [id=" + id + ", name=" + name + ", introduce=" + introduce + ", logo=" + logo + ", isDetail="
				+ isDetail + ", type=" + type + ", startQuota=" + startQuota + ", endQuota=" + endQuota + ", loanRate="
				+ loanRate + ", passRate=" + passRate + ", auditType=" + auditType + "]";
	}
